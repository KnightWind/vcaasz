    ...
    <td><br />
      ...
      <tr>
        <td height="44"><p class="style1">尊敬的${user.trueName}，您好！
          ...
          <p class="style1">感谢您使用<strong>商会云会议中心系统</strong>，您的管理员帐户已经修改，修改后的相关信息如下：</p>
      ...
      <tr>
		...
		<table width="556" border="0" align="center" cellpadding="4" cellspacing="0">
		     <tr>
		         <td width="50%"><ul>
              <li><span class="style6">您可以访问 <a  href="http://${siteaddress}/admin">商会云会议管理平台</a> 登录系统：<a href="http://${siteaddress}/admin">http://${siteaddress}/admin</a></span></li>
    ...
    <td><br />
      ...
      <tr>
        <td height="44"><p class="style1">Dear ${user.trueName}！
          <p class="style1">Thank you for using <strong>ConfCloud</strong>system. Your account has been modified. Below is detail info after modified</p>
      ...
      <tr>
		...
		<table width="556" border="0" align="center" cellpadding="4" cellspacing="0">
		     <tr>
		         <td width="80%"><ul>
                 <li><span class="style6">You can visit the system via this link:<a href="http://${siteaddress}/admin">http://${siteaddress}/admin</a></span></li>
