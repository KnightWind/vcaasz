    ...
    <td><br />
      ...
      <tr>
        <td height="44"><p class="style1">尊敬的${user.trueName}，您好！
          ...
          <p class="style1">感谢您使用ConfCloud系统,您要求修改的信息已成功更改。修改后的帐户相关信息如下：</p>
          <p class="style1"><strong> 帐户信息</strong></p>
         </td>
      </tr>
      <tr>
        <td><br />
		<table width="556" border="0" align="center" cellpadding="4" cellspacing="0">
		     <tr>
		         <td width="90%"><ul>
              <li><span class="style6">您可以访问商会云会议平台登录系统：<a href="http://${siteaddress}">http://${siteaddress}</a></span></li>
    ...
    <td><br />
      ...
      <tr>
        <td height="44"><p class="style1">Dear ${user.trueName}！
          <p class="style1">Thank you for using <strong>ConfCloud</strong>. This email contains your personal account information and all materials to drive you in using the service.</p>
          <p class="style1"><span class="style6"> Account Information</span>          
          </td>
      </tr>
      <tr>
        <td><br />
