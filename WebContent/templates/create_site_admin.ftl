    ...
    <td><br />
      ...
      <tr>
        <td height="44"><p class="style1">尊敬的${user.trueName}，您好！
          ...
          <p class="style1">感谢您使用<strong>商会云</strong>系统，您的管理员帐户已开通，相关信息如下：</p>
    ...
    <td><br />
      ...
      <tr>
        <td height="44"><p class="style1">Dear ${user.trueName}！
          <p class="style1">Thank you for using <strong>ConfCloud</strong>system. Your account has been created. Below is detail info</p>
