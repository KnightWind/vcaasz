    ...
    <td><br />
      ...
      <tr>
        <td height="44"><p class="style1">尊敬的${userBase.trueName}，您好！
          ...
          <p class="style1">感谢您使用<strong>商会云会议中心</strong>,您可以点击 <a href="http://${siteBase.siteSign}.confcloud.cn/admin">商会云企业管理平台</a> 登录系统。</p>
    ...
    <td><br />
      ...
      <tr>
        <td height="44"><p class="style1">Dear ${userBase.trueName}！
          <p class="style1">Thank you for using  <strong>ConfCloud</strong> Please click 
