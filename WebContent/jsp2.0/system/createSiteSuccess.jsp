...
.button-host {
    background: url("/static/images/jzbgchange.jpg") no-repeat scroll 0 0 transparent;
    color: #333333;
    height: 25px;
    line-height: 25px;
    outline: medium none;
...
<body onload="loaded()">
	<form id="siteSuccessForm" action="">
		...
		<div style="text-align: center">
			<c:if test="${siteBase.chargeMode == 1}">
				<input class="button-host" type="button" value="${LANG['bizconf.jsp.system.index.res2']}" onclick="creatHost()"/>
			</c:if>
...
function creatHost() {
	...
	parent.createOrUpdateHost(siteId);
}
</script>
