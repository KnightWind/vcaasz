...
<script type="text/javascript">
	...
	function resizeHeight(subHigth) {
		...
		if(!subHigth){
			...
			$(".main_container").height(subHigth);
			$(".main_left").height(subHigth);
			$(".main_right").height(subHigth);
		}
	}
	
	function addOrUpdateDataCenter(dataCenterId){
		if(dataCenterId){
			$("<div id=\"dataCenterDiv\"/>").showDialog({
				"title": "修改数据中心",
				"dialogClass" : "ui-dialog-smile",
				"url" : "/system/dataCenter/addOrUpdate?dataCenterId="+dataCenterId,
			...
			$("<div id=\"dataCenterDiv\"/>").showDialog({
				"title": "添加数据中心",
				"dialogClass" : "ui-dialog-smile",
				"url" : "/system/dataCenter/addOrUpdate",
				"type" : VIEW_TYPE.hostUser,
	...
	/**
		管理RC的ip
	*/
	function listRCList(centerId){

		$("<div id=\"listRCIpDiv\"/>").showDialog({
			"title": "管理RC",
			"dialogClass" : "ui-dialog-smile",
			"url" : "/system/dataCenter/listIp?centerId="+centerId,
			"type" : VIEW_TYPE.hostUser,
			"action" : ACTION.create,
			"width" : 530,
			"height" : 480
	...
	function addOrUpdateRCIpAddress(centerId,id){
		if(id){
			$("<div id=\"addRCIpDiv\"/>").showDialog({
				"title": "管理RC",
				"dialogClass" : "ui-dialog-smile",
				"url" : "/system/dataCenter/addOrUpdateIp?centerId="+centerId+"&id="+id,
				"type" : VIEW_TYPE.hostUser,
				"action" : ACTION.create,
				"width" : 500,
				"height" : 140
			...
			$("<div id=\"addRCIpDiv\"/>").showDialog({
				"title": "管理RC",
				"dialogClass" : "ui-dialog-smile",
				"url" : "/system/dataCenter/addOrUpdateIp?centerId="+centerId,
				"type" : VIEW_TYPE.hostUser,
				"action" : ACTION.create,
				"width" : 500,
				"height" : 140
	...
	function maCreateOrUpdateHost(siteId,userId) {
		if(userId) {
			$("<div id=\"hostDiv\"/>").showDialog({
				"title": "${LANG['bizconf.jsp.system.index.res1']}",
				"dialogClass" : "ui-dialog-smile",
				"url" : "/system/lic/goMaEditHost?siteId="+siteId+"&userId="+userId,
				"type" : VIEW_TYPE.hostUser,
				"action" : ACTION.update,
				"width" : 510,
				"height" : 480
	...
	function msManger(id) {
		$("<div id=\"msDiv\"/>").showDialog({
			"title" : "${LANG['bizconf.jsp.system.index.msinfo1']}",
			"dialogClass" : "ui-dialog-smile",
			"url" : "/system/ms/toEditeMs?msId="+id,
			"type" : VIEW_TYPE.hostUser,
			"action" : ACTION.create,
			"width" : 480,
			"height" : 300
	...
	function msGroupManger(id) {
		$("<div id=\"msgroupDiv\"/>").showDialog({
			"title" : "${LANG['bizconf.jsp.system.index.msinfo2']}",
			"dialogClass" : "ui-dialog-smile",
			"url" : "/system/ms/toEditeMsGroup?groupId="+id,
			"type" : VIEW_TYPE.hostUser,
			"action" : ACTION.create,
			"width" : 480,
			"height" : 220
	...
	function showMSSelect(id,seletedIds) {
		$("<div id=\"showMSDiv\"/>").showDialog({
			"title" : "${LANG['bizconf.jsp.system.index.msinfo3']}",
			"dialogClass" : "ui-dialog-smile",
			"url" : "/system/ms/showAllMsSelect?groupId="+id+"&selectedIds="+seletedIds,
			"type" : VIEW_TYPE.hostUser,
			"action" : ACTION.create,
			"width" : 600,
			"height" : 380
	...
	function showUsingSites(id) {
		$("<div id=\"showSitesDiv\"/>").showDialog({
			"title" : "${LANG['bizconf.jsp.system.index.msinfo4']}",
			"dialogClass" : "ui-dialog-smile",
			"url" : "/system/ms/showMGSites?groupId="+id,
			"type" : VIEW_TYPE.hostUser,
			"action" : ACTION.create,
			"width" : 550,
			"height" : 380
	...
	//设置Download地址
	function downloadSetting(id) {
		if (id) {
			$("<div id=\"settingDiv\"/>").showDialog({
				"title" : "设置Download地址",
				"dialogClass" : "ui-dialog-smile",
				"url" : "/system/site/setting/" + id,
				"type" : VIEW_TYPE.site,
				"action" : ACTION.update,
				"width" : 600,
				"height" : 240
	...
	function viewHost(id) {
		$("<div id=\"siteDiv\"/>").showDialog({
			"title" : "${LANG['system.user.meaasge.lookup']}",
			"dialogClass" : "ui-dialog-smile",
			"url" : "/system/conf/viewHost?id="+id,
			"type" : VIEW_TYPE.site,
			"action" : ACTION.view,
			"width" : 420,
			"height" : 250
	...
	//view eventLog optDesc
	function viewSysSiteDetails(id) {
		$("<div id=\"optDescDiv\"/>").showDialog({
			"title" : "查看详情",
			"dialogClass" : "ui-dialog-smile",
			"url" : "/system/logs/viewSysSiteDetails/" + id,
			"type" : VIEW_TYPE.site,
			"action" : ACTION.view,
			"width" : 700,
			"height" : 534
	...
	//view eventLog optDesc
	function viewSysAdminDetails(id) {
		$("<div id=\"optDescDiv\"/>").showDialog({
			"title" : "查看详情",
			"dialogClass" : "ui-dialog-smile",
			"url" : "/system/logs/viewSysAdminDetails/" + id,
			"type" : VIEW_TYPE.site,
			"action" : ACTION.view,
			"width" : 700,
			"height" : 470
	...
	function showConflogs(id) {
		$("<div id=\"meetingSchedule\"/>").showDialog({
			...
			"dialogClass" : "ui-dialog-smile",
			"url" : "<%=request.getContextPath()%>/user/conflog/reportInfoList?confId="+id,
	...
	//CS加入会议
	function joinByCS(cId) {
		
		//var divHeight="auto";
		var divHeight="330";//默认情况
		if ($.browser.msie) {
			divHeight=330;
		}
		$("<div id=\"joinMeeting\"/>").showDialog({
			...
			"iconClass":"icon-join",
			"url" : "/join/gotojoinPage?joinType=4&role=1&blank=0&cId="+cId,
...
<!--             <li class="b_line"><a class="li_alink" href="/system/email/goTemplate" target="mainFrame">${LANG['system.menu.config.template']}</a></li> -->
<!--             <li class="b_line"><a class="li_alink" href="/system/ms/showmses" target="mainFrame">${LANG['bizconf.jsp.system.index.itemms']}</a></li> -->
<!--             <li><a class="li_alink" href="/system/ms/showmsgroups" target="mainFrame">${LANG['bizconf.jsp.system.index.itemmsgroup']}</a></li> -->
		          <!-- 配置多数据中心 -->
          		<li class="b_line"><a class="li_alink" href="/system/dataCenter/list" target="mainFrame">数据中心管理</a></li>
          </ul>
        ...
        <li><span class="nav_top02"><a class="" href="#"><b>${LANG['system.menu.site.manage']}</b></a></span>
          <ul class="sub_nav">
            <li class="b_line"><a class="li_alink li_actived" href="/system/site/list" target="mainFrame">${LANG['system.menu.site.list']}</a></li>
            <li class="b_line"><a class="li_alink" href="/system/user/siteUserBaseAll?kefu=1" target="mainFrame">${LANG['system.menu.config.user']}</a></li>
          </ul>
        </li>
        <%-- <c:if test="${isSuperSystemAdmin}">
...
<!--           	WithCondition?confStatus=${CONF_STATUS_OPENING } -->

            <li class="b_line"><a class="li_alink" href="/system/conf/listWithCondition?confStatus=2&kefu=1" target="mainFrame">${LANG['system.menu.info.meeting']}</a></li>
            <c:if test="${user.sysType gt 6}">
            	<li class="b_line"><a class="li_alink" href="/system/statistical/overview" target="mainFrame">${LANG['website.site.admin.meetingdata.statis'] }</a></li>
            	<%--<li class="b_line"><a class="li_alink" href="/system/logs/syslist" target="mainFrame">${LANG['system.menu.info.log.sysManager']}</a></li>--%>
	            <li class="b_line"><a class="li_alink" href="/system/logs/siteloglist" target="mainFrame">${LANG['system.menu.info.log.userManager']}</a></li>
	            <li><a class="li_alink" href="/system/loginLog/getLogList" target="mainFrame">${LANG['bizconf.jsp.system.user.login.log']}</a></li>
         	</c:if>
          </ul>
        </li>
...
<!--         </li> -->
         ...
         <li><span class="nav_top06"><a class="" href="#"><b>${LANG['system.menu.info.user.manage']}</b></a></span>
          <ul class="sub_nav">
            ...
            <li class="b_line"><a class="li_alink" href="/system/profile/tofaverSetting" target="mainFrame">${LANG['website.user.leftmenu.preferences']}</a></li>
            
          </ul>
        </li>
        <li><span class="nav_top06"><a class="" href="#"><b>${LANG['website.system.index.common.problems']}</b></a></span>
          <ul class="sub_nav">
            <li class="b_line"><a class="li_alink" href="/system/faq" target="mainFrame">${LANG['website.system.index.common.problems']}</a></li>
          </ul>
        </li>
    </ul>    
</div>
