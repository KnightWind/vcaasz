  ...
  <!-- 要实现图片切换TODO -->
    ...
    <div id="banner">
      <div class="login" id="login-form" >
        <form id="loginForm" action="/user/login/formcheck" method="post">
          <div class="title" style="margin-bottom: 0px;"><i class="icon camera"></i>${LANG['website.user.conf.list.join.hostmeeting'] }</div>
          <c:if test="${!empty errorMessage}">
         	 <div  style="width:auto; height: 18px;font-size:14px; font-weight:400; color: red;background-color:#fff;opacity:0.7;filter:alpha(opacity=70);z-index: 102;left: 2px;top:20px;position: absolute;">${errorMessage }</div>
          </c:if>
          <noscript>
          ...
          <div class="form-group" style="margin-top: 18px;">
            ...
            <button type="button" class="btn btn-primary" onclick="login();">${LANG['bizconf.jsp.index.res21'] }</button>
          </div>
