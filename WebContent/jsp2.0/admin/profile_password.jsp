...
<div class="box">
	...
	<div class="body">
		<form id="personal-form" action="/admin/profile/changePwd" method="post" class="personal-form">
			<div class="form-item">
			...
			<div class="form-item submit-item">
				<div class="widget">
					...
					<c:if test="${!empty infoMessage}">
	        			...
	        			<img src="/static/images/ys_r_bg.jpg" width="16" height="14" style="margin-left:15px;margin-top:5px;margin-right: 5px"/><label style='color:#258021'>${LANG['website.admin.profile.password.successinfo']}</label>
	        			</span>
		 			</c:if>
...
var validString = {
		...
		loginPass: {
			...
			safeTipError:"${LANG['website.user.profile.val.newpass.tip1'] }"
		},
		loginPass2: {
			onShow: "",
			onFocus: "",
		...
		$("#loginPass").formValidator({
			...
			fun:function(val,elem){
				...
				if(!ValidatorPass(loginPass)){
					return validString.loginPass.safeTipError;	
				}else{
					return true;
				}
			}
