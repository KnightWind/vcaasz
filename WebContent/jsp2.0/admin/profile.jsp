...
<div class="box">
	...
	<div class="body">
		<form id="personal-form" action="/admin/profile/submit" method="post" class="personal-form">
			<div class="form-item">
				<label class="title">${LANG['website.user.profile.loginname'] }：</label>
				<div class="widget">
					<input id="loginName" name="loginName" type="text" value="${currentSiteAdmin.loginName}" class="input-text" />
			...
			<div class="form-item">
				...
				<div class="widget">
					<input name="trueName" id="trueName" type="text" value="${currentSiteAdmin.trueName}" class="input-text" />
					<span class="form-required"></span>
			...
			<div class="form-item">
				...
				<div class="widget">
					<input name="enName" id="enName" type="text" value="${currentSiteAdmin.enName}" class="input-text" />
			...
			<div class="form-item">
				...
				<div class="widget">
					<input type="text" name="userEmail" id="userEmail" value="${currentSiteAdmin.userEmail}" class="input-text" />
					<span class="form-required"></span>
			...
			<div class="form-item">
				...
				<div class="widget">
					<input type="text" name="mobile" id="mobile" value="${currentSiteAdmin.mobile}" class="input-text" />
