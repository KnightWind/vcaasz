		...
		<div class="wrapper">
			<div class="forget-box">
				...
				<div class="box-wrapper box-wrapper-reset-pass">
					...
					<form action="/admin/password/save" name="passwordResetForm" id="passwordResetForm" class="passwordResetForm" method="post">
...
<!-- 									<i class="icon"></i>请正确填写密码！ -->
						...
						<div class="form-item captcha-widget">
							...
							<div class="widget">
								...
								<a class="update-captcha" href="javascript:;" onclick="randomImg()">${LANG['website.common.authcode.next'] }</a>
								<p class="error">
		...
		$("#lp").formValidator({
			...
			fun:function(val,elem){
				...
				if(!ValidatorPass(loginPass)){
					return validString.lp.safeTipError;	
				}else{
					return true;
				}
			}
