 ...
 */
$(function () {
//  var address = 'url(/Formal/images/login/bg/{1}/1920.jpg)';
...
//  $('body').css('background-image', address.replace('{1}', '07'));//目前指定图片固定不进行切换
  
//	var address = 'url(/Formal/images/login/bg/{1}/1920.jpg)';
//	var background = parseInt(localStorage.getItem('background') || '00', 10);
//	if (background < 10) {
//      background = '0' + background;
//    }
//	if(background <= 0){
//		background = "0" + 1;
//	}
	//$('body').css('background-image', address.replace('{1}', background));
});
