...
public class ESpaceMeetingAsSoapResponseGetSystemLicenseResponse  implements java.io.Serializable {
    private com.bizconf.vcaasz.soap.conf.ESpaceMeetingAsSoapLicenseRes lic;

    public ESpaceMeetingAsSoapResponseGetSystemLicenseResponse() {
    }

    public ESpaceMeetingAsSoapResponseGetSystemLicenseResponse(
           com.bizconf.vcaasz.soap.conf.ESpaceMeetingAsSoapLicenseRes lic) {
           this.lic = lic;
    }
     ...
     * @return lic
     */
    public com.bizconf.vcaasz.soap.conf.ESpaceMeetingAsSoapLicenseRes getLic() {
        return lic;
    }
     ...
     * @param lic
     */
    public void setLic(com.bizconf.vcaasz.soap.conf.ESpaceMeetingAsSoapLicenseRes lic) {
        this.lic = lic;
    }
